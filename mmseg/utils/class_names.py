...
def my_city_palette():
    return [ [100, 35, 232], [70, 70, 70], [102, 102, 156],
         [190, 153, 153], [153, 153, 153], [250, 170, 30], [220, 220, 0],

          ]

def my_city_1ship_classes():
    return [
        '__ignore__',
            'sea',
            'sky',
...
def my_city_1ship_palette():
    return [ [107, 142, 35], [152, 251, 152], [70, 130, 180],
