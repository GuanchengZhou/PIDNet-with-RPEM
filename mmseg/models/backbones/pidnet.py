...
#         self.lamdba = nn.ParameterList([nn.Parameter(torch.randn(1))for i in range(self.channel)])
#         if act_cfg_out:
...
#             self.d_branch_layers = nn.ModuleList([
#                 self._make_single_layer(BasicBlock, channels * 2, channels,),
#                 self._make_layer(Bottleneck, channels, channels, 1, _space=space_block)
#             ])
#             channel_expand = 1
#             spp_module = PAPPM
#             dfm_module = LightBag
...
#
#     def _make_stem_layer(self, in_channels: int, channels: int,
#                          num_blocks: int, space_ = False) -> nn.Sequential:
#         """Make stem layer.
#
#         Args:
#             in_channels (int): Number of input channels.
...
#                 act_cfg=self.act_cfg),]
#         if space_:
#             layers.append(Space_block(channels))
#         layers.append(
#             ConvModule(
#                 channels,
#                 channels,
...
#                     num_blocks: int,
#                     stride: int = 1,
#                     _space: bool = False,) -> nn.Sequential:
#         """Make layer for PIDNet backbone.
#         Args:
#             block (BasicBlock): Basic block.
#             in_channels (int): Number of input channels.
